...
public class FirstArray
{
    ...
    //For-each Loop for Java Array.
        ...
        //printing array using for-each loop
            for(int i:arr)//A for-each loop is used to iterate through each element of the array 'arr'. The variable 'i' takes the value of each element of the array one by one during each iteration.
